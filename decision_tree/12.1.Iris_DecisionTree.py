...
if __name__ == "__main__":
    ...
    # min_samples_leaf = 10：叶节点最少的样本个数为10个；若将某结点分支后，得到的每个子结点样本数目都大于10，则完成分支；否则，不进行分支
    model = DecisionTreeClassifier(criterion='entropy', max_depth=6, min_samples_leaf=3)
    model = model.fit(x, y)
    ...
    # 1、输出
    with open('F:\code\ml_algorithm_practice\\decision_tree\\iris.dot', 'w') as f:
